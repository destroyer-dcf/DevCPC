...
;dw SOLDADO_R0,SOLDADO_R2,SOLDADO_R1,SOLDADO_R2,0,0,0,0 ;2
;dw SOLDADO_L0,SOLDADO_L2,SOLDADO_L1,SOLDADO_L2,0,0,0,0 ;1
;dw SOLDADO_L0,SOLDADO_L2,SOLDADO_L1,SOLDADO_L2,5,0,0,0 ;3
;dw SOLDADO_R0,SOLDADO_R2,SOLDADO_R1,SOLDADO_R2,4,0,0,0 ;4
;dw SOLDADO_L0,SOLDADO_L2,SOLDADO_L1,SOLDADO_L2,5,0,0,0 ;5
;dw SOLDADO_R0,SOLDADO_R2,SOLDADO_R1,SOLDADO_R2,4,0,0,0 ;6
;dw SOLDADO_L0,SOLDADO_L2,SOLDADO_L1,SOLDADO_L2,5,0,0,0 ;7
;dw SOLDADO_R0,SOLDADO_R2,SOLDADO_R1,SOLDADO_R2,4,0,0,0 ;8
;dw ARTHUR1,ARTHUR2,ARTHUR3,ARTHUR1,0,0,0,0 ;9
;dw BIRD_UP,BIRD_UP,BIRD_DW,BIRD_DW,0,0,0,0;10
