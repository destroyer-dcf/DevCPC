...
char *cad="AAA";
 ...
 // configuramos colspall e inicio del juego
 // ----------------------------------------
 _8BP_colspall_2(&cor,&cod);
 _8BP_setlimits_4(0,80,0,200); //margen pantalla completa
 _8BP_setupsp_3(22,9,22); //definimos gráfico UI
 _8BP_printsp_3(22,185,0); //dibujamos UI
 _8BP_setlimits_4(0,80,0,185); //margen del juego
 _8BP_printat_4(0,190,21,_basic_str(vidas)); //imprimimos número de vidas
 _8BP_printat_4(0,190,39,_basic_str(puntos)); //imprimimos puntuación inicial
 _8BP_printat_4(0,190,67,_basic_str(level)); //imprimimos nivel inicial

 //Musica DEMO
 _8BP_music_4(1,0,0,6); 
...
//Control de la nave
  //Right
   ...
   sp=23+ sp % 8; last=c;
   _8BP_setupsp_3(sp,9,16);//disparo
  ...
  */
   ...
   /*if (puntos < 100)
   {
      _8BP_stars_5(0,10,4,3,0);
   }
   */
   //_8BP_stars_5(20,10,2,4,0);
   //_8BP_stars_5(0,5,4,3,0);
...
if (cor==31) //return 1;
  {
    ...
    {
      vidas-=1;
      _8BP_printat_4(0,190,21,_basic_str(vidas));
    }
    
  }
_8BP_setupsp_3(cor,7,1);


_8BP_setupsp_3(cor,0,5);

if (cod<22){
  _basic_sound(1,2000,10,12,0,0,15);
  _8BP_setupsp_3(cod,7,1);//animacion 
  _8BP_setupsp_3(cod,0,5);
  _basic_call(0xbd19);
  puntos+=10;
  puntos_str= _basic_str(puntos);
  _8BP_printat_4(0,190,39,puntos_str);
  }
