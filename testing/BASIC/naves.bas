...
1 '
151 |SETLIMITS,0,80,0,200
152 |SETUPSP,22,9,22:|PRINTSP,22,185,0
153 |SETLIMITS,0,80,0,185
1 '

160 c=c+1
170 IF INKEY(27) THEN 190 'Right
180 IF x<73 THEN x=x+1: GOTO 210
190 IF INKEY(34) THEN 210 'Left
200 IF x>-1 THEN x=x-1
210 IF INKEY(67) THEN 230 'Up
220 IF y>1 THEN y=y-2:GOTO 250
230 IF INKEY(69) THEN 250 'Down
240 IF y<162 THEN y=y+2
250 IF c-last<8 THEN 320
260 IF INKEY(47) THEN 320 'Fire
...
450 '|STARS,0,10,4,3,0
451 '|STARS,20,10,2,4,0
...
510 |SETUPSP,cor,7,1:|SETUPSP,cor,0,4+1
520 IF cod<22 THEN |SETUPSP,cod,7,1:|SETUPSP,cod,0,4+1:'BORDER 7: CALL &BD19:BORDER 0 
530 RETURN
540 '--- fin ---
550 MODE 2:LIST
560 |MUSIC
