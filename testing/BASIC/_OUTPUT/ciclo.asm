...
;mini_BASIC/minibasic.h:178: static char buffer[]="          ";
	ld	hl, #__basic_str_buffer_65536_271
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0001)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0002)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0003)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0004)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0005)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0006)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0007)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0008)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x0009)
	ld	(hl), #0x20
	ld	hl, #(__basic_str_buffer_65536_271 + 0x000a)
	ld	(hl), #0x00
;--------------------------------------------------------
; Home
;--------------------------------------------------------
...
;ciclo.c:53: vidas=3;
	ld	l, #0x03
	ld	(_vidas), hl
;ciclo.c:55: int tintas[5]={1,2,2,3,3};
	ld	hl, #0
	add	hl, sp
	ex	de, hl
	ld	l, e
	...
	inc	hl
	ld	(hl), #0x00
;ciclo.c:59: _8BP_colspall_2(&cor,&cod);
	ld	hl, #_cod
	push	hl
	ld	hl, #_cor
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:60: _8BP_setlimits_4(0,80,0,200); //margen pantalla completa
	ld	hl, #0x00c8
	push	hl
	ld	l, #0x00
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:61: _8BP_setupsp_3(22,9,22); //definimos gráfico UI
	ld	hl, #0x0016
	push	hl
	ld	l, #0x09
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:62: _8BP_printsp_3(22,185,0); //dibujamos UI
	ld	hl, #0x0000
	push	hl
	ld	l, #0xb9
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:63: _8BP_setlimits_4(0,80,0,185); //margen del juego
	ld	hl, #0x00b9
	push	hl
	ld	l, #0x00
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:64: _8BP_printat_4(0,190,21,_basic_str(vidas)); //imprimimos número de vidas
	ld	hl, (_vidas)
	push	hl
	call	__basic_str
	ex	(sp),hl
	...
	pop	af
	pop	af
;ciclo.c:65: _8BP_printat_4(0,190,39,_basic_str(puntos)); //imprimimos puntuación inicial
	ld	hl, (_puntos)
	push	hl
	call	__basic_str
	ex	(sp),hl
	...
	pop	af
	pop	af
;ciclo.c:66: _8BP_printat_4(0,190,67,_basic_str(level)); //imprimimos nivel inicial
	ld	hl, #0x0001
	ex	(sp),hl
	call	__basic_str
	ex	(sp),hl
	...
	pop	af
	pop	af
;ciclo.c:69: _8BP_music_4(1,0,0,6); 
	ld	hl, #0x0006
	push	hl
	ld	l, #0x00
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:71: _8BP_map2sp_1(1);
	ld	h,#0x01
	ex	(sp),hl
	inc	sp
	call	__8BP_map2sp_1
	inc	sp
;ciclo.c:73: _8BP_umap_6(41600,41660,0,1000,0,1000);
	ld	hl, #0x03e8
	push	hl
	ld	hl, #0x0000
	push	hl
...
;ciclo.c:79: c=c+1;
	...
	inc	hl
	ld	(_c), hl
;ciclo.c:83: if (_basic_inkey(27)>0) goto label_140;
	ld	a, #0x1b
	push	af
	inc	sp
	call	__basic_inkey
...
;ciclo.c:84: if (x<73)
	...
	sbc	a, #0x80
	jr	NC,00111$
;ciclo.c:85: x=x+1; goto label_160;
	ld	hl, (_x)
	inc	hl
	ld	(_x), hl
	jr	00111$
;ciclo.c:87: label_140:
00106$:
;ciclo.c:89: if (_basic_inkey(34)>0) goto label_160;
	ld	a, #0x22
	push	af
	inc	sp
	call	__basic_inkey
...
;ciclo.c:91: x=x-1;
	...
	dec	hl
	ld	(_x), hl
;ciclo.c:93: label_160:
00111$:
;ciclo.c:95: if (_basic_inkey(67)>0) goto label_180;
	ld	a, #0x43
	push	af
	inc	sp
	call	__basic_inkey
...
00237$:
	jp	P, 00121$
;ciclo.c:97: y=y-2;goto label_200;
	ld	hl, (_y)
	dec	hl
	dec	hl
	ld	(_y), hl
	jr	00121$
;ciclo.c:99: label_180:
00116$:
;ciclo.c:101: if (_basic_inkey(69)>0) goto label_200;
	ld	a, #0x45
	push	af
	inc	sp
	call	__basic_inkey
...
;ciclo.c:103: y=y+2;
	...
	inc	hl
	ld	(_y), hl
;ciclo.c:105: label_200:
00121$:
;ciclo.c:107: if (c-last<8) goto label_270;
	ld	hl, (_c)
	ld	bc, (_last)
	cp	a, a
	sbc	hl, bc
	...
	sbc	a, #0x00
	jp	C, 00126$
;ciclo.c:108: if (_basic_inkey(47)>0) goto label_270;
	ld	a, #0x2f
	push	af
	inc	sp
	call	__basic_inkey
...
;ciclo.c:110: sp=23+ sp % 8; last=c;
	...
	ld	hl, (_c)
	ld	(_last), hl
;ciclo.c:111: _8BP_setupsp_3(sp,9,16);//disparo
	ld	hl, #0x0010
	push	hl
	ld	l, #0x09
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:112: _8BP_setupsp_3(sp,0,1+8+32);
	ld	hl, #0x0029
	push	hl
	ld	l, #0x00
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:113: _8BP_locatesp_3(sp,y-4,x);
	ld	iy, #_y
	ld	a, 0 (iy)
	add	a, #0xfc
	ld	e, a
	...
	pop	af
;ciclo.c:114: _8BP_setupsp_4(sp,5,-5,0);
	inc	sp
	ld	hl,#0x0000
	ex	(sp),hl
	ld	hl, #0xfffb
	...
	pop	af
	pop	af
;ciclo.c:118: _basic_sound(4,10,10,10,0,1,0);
	xor	a, a
	ld	d,a
	ld	e,#0x01
	push	de
	...
	add	hl, sp
	ld	sp, hl
;ciclo.c:120: label_270:
00126$:
;ciclo.c:122: _8BP_locatesp_3(31,y,x);
	ld	hl, (_x)
	push	hl
	ld	hl, (_y)
	push	hl
	...
	call	__8BP_locatesp_3
	pop	af
;ciclo.c:123: _8BP_autoall_1(1);
	inc	sp
	ld	hl,#0x0001
	ex	(sp),hl
	call	__8BP_autoall_1
	pop	af
;ciclo.c:124: _8BP_map2sp_2((c <<1)%300,0);
	ld	hl, (_c)
	add	hl, hl
	ld	bc, #0x012c
	push	bc
	...
	pop	af
	pop	af
;ciclo.c:125: _8BP_printspall();
	call	__8BP_printspall
;ciclo.c:126: _8BP_colspall();
	call	__8BP_colspall
;ciclo.c:131: if ((c & 63)>0) goto label_450;
	ld	a,(#_c + 0)
	and	a, #0x3f
	jp	NZ,00132$
;ciclo.c:141: ruta=_basic_rnd(2) ; 
	ld	hl, #0x0002
	push	hl
	call	__basic_rnd
	pop	af
	ld	(_ruta), hl
;ciclo.c:142: ex=10+_basic_rnd(50) ;
	ld	hl, #0x0032
	push	hl
	call	__basic_rnd
	pop	af
...
00141$:
	...
	sbc	a, #0x80
	jr	NC,00132$
;ciclo.c:146: e=e+1;if (e==22) e=10;
	ld	hl, (_e)
	inc	hl
	ld	(_e), hl
	ld	iy, #_e
	...
	ld	(_e), hl
00130$:
;ciclo.c:147: _8BP_setupsp_3(e,9,17);//ovni
	push	bc
	ld	hl, #0x0011
	push	hl
	ld	l, #0x09
	...
	pop	af
	pop	bc
;ciclo.c:150: _8BP_locatesp_3(e,-80,ex);
	ld	hl,#_e + 0
	ld	d, (hl)
	push	bc
	ld	hl, (_ex)
	...
	inc	sp
	pop	bc
;ciclo.c:151: _8BP_routesp_2(e,i*6);
	ld	l, c
	ld	h, b
	add	hl, hl
	add	hl, bc
...
;ciclo.c:144: for (int i=1;i<5;i++)
	inc	bc
	jp	00141$
;ciclo.c:155: label_450:
00132$:
;ciclo.c:165: if (cor <32) rescol=rutina_colision();
	ld	iy, #_cor
	ld	a, 0 (iy)
	sub	a, #0x20
	ld	a, 1 (iy)
	...
	ld	(_rescol), hl
00134$:
;ciclo.c:166: if (rescol==1) goto END;
	ld	iy, #_rescol
	ld	a, 0 (iy)
	dec	a
	or	a, 1 (iy)
	jr	Z,00139$
;ciclo.c:169: if (c==3000) return 0;
	ld	iy, #_c
	ld	a, 0 (iy)
	sub	a, #0xb8
	jp	NZ,00101$
...
_CHAR_CR:
	.db #0x0d	; 13
	.db #0x00	; 0
;ciclo.c:181: int  rutina_colision()
;	---------------------------------
; Function rutina_colision
; ---------------------------------
_rutina_colision::
;ciclo.c:183: if (cor==31) //return 1;
	ld	iy, #_cor
	ld	a, 0 (iy)
	sub	a, #0x1f
	or	a, 1 (iy)
	jr	NZ,00105$
;ciclo.c:185: if (vidas==0)
	ld	iy, #_vidas
	ld	a, 1 (iy)
	or	a, 0 (iy)
	jr	NZ,00102$
;ciclo.c:187: return 1;
	ld	hl, #0x0001
	ret
00102$:
;ciclo.c:191: vidas-=1;
	ld	hl, (_vidas)
	dec	hl
;ciclo.c:192: _8BP_printat_4(0,190,21,_basic_str(vidas));
	ld	(_vidas), hl
	push	hl
	call	__basic_str
	ex	(sp),hl
	...
	pop	af
00105$:
;ciclo.c:196: _8BP_setupsp_3(cor,7,1);
	ld	hl, #0x0001
	push	hl
	ld	l, #0x07
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:199: _8BP_setupsp_3(cor,0,5);
	ld	hl, #0x0005
	push	hl
	ld	l, #0x00
	push	hl
...
;ciclo.c:201: if (cod<22){
	...
	sbc	a, #0x80
	jr	NC,00107$
;ciclo.c:202: _basic_sound(1,2000,10,12,0,0,15);
	ld	a, #0x0f
	push	af
	inc	sp
	xor	a, a
	...
	add	hl, sp
	ld	sp, hl
;ciclo.c:203: _8BP_setupsp_3(cod,7,1);//animacion 
	ld	hl, #0x0001
	push	hl
	ld	l, #0x07
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:204: _8BP_setupsp_3(cod,0,5);
	ld	hl, #0x0005
	push	hl
	ld	l, #0x00
	push	hl
	...
	pop	af
	pop	af
;ciclo.c:205: _basic_call(0xbd19);
	ld	hl, #0xbd19
	ex	(sp),hl
	call	__basic_call
	pop	af
;ciclo.c:206: puntos+=10;
	ld	hl, #_puntos
	ld	a, (hl)
	add	a, #0x0a
	ld	(hl), a
	...
	inc	(hl)
00127$:
;ciclo.c:207: puntos_str= _basic_str(puntos);
	ld	hl, (_puntos)
	push	hl
	call	__basic_str
	pop	af
;ciclo.c:208: _8BP_printat_4(0,190,39,puntos_str);
	ld	(_puntos_str), hl
	push	hl
	ld	hl, #0x0027
	push	hl
